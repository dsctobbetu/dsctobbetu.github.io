...
function checkCertificate(){
    var num = parseInt(document.getElementById('cert_id').value);
    switch (num){
        case 1: alert("This certificate was issued to Ufuk Karaca for attending Internship Panel 2021, organized by DSC TOBB ETU on 2-3 January 2021.");
                break;
        default: alert("Please enter a valid certificate number!");
                break;
    }
}